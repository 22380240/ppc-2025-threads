...
class RamsSVerticalGauss3x3TbbTest
    : public ::testing::TestWithParam<
          std::tuple<int, int, std::vector<uint8_t>, std::vector<float>, std::vector<uint8_t>>> {};

static void RunTest(int width, int height, std::vector<uint8_t>& in, std::vector<float>& kernel,
...
TEST(rams_s_vertical_gauss_3x3_tbb, test_with_fixture) {
  ...
  cv::Mat img_expected =
      cv::imread(ppc::util::GetAbsolutePath("tbb/rams_s_vertical_gauss_3x3/data/flower-blurred.png"));
